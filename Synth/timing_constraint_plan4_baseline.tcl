...
#//-----------------------------------------------------------------------------------
#// # Defining timing constraints for Clock Plan #4 for basic logic design : 
#// # Clock Frequencies in MHz (Global/M/S 0 - M/S 1 - M/S#2 - M/S 3): 800-400-200-160
#// # Setup time for input ports - 30ps
#// # Hold time for output ports - 10ps
#//-----------------------------------------------------------------------------------

create_clock -name global_clk -period 1.25 [get_ports {aclk}]  ;# Global 800 MHz

create_clock -name master_clk_0 -period 1.25 [get_ports {mst0_aclk}]  ;# 800 MHz
create_clock -name master_clk_1 -period 2.5 [get_ports {mst1_aclk}] ;# 400 MHz
create_clock -name master_clk_2 -period 5 [get_ports {mst2_aclk}] ;# 200 MHz 
create_clock -name master_clk_3 -period 6.25 [get_ports {mst3_aclk}] ;# 160 MHz

create_clock -name slave_clk_0 -period 1.25 [get_ports {slv0_aclk}]    ;# 800 MHz
create_clock -name slave_clk_1 -period 2.5 [get_ports {slv1_aclk}]   ;# 400 MHz
create_clock -name slave_clk_2 -period 5 [get_ports {slv2_aclk}]   ;# 200 MHz
create_clock -name slave_clk_3 -period 6.25 [get_ports {slv3_aclk}]   ;# 160 MHz
